...
if [ "$PLATFORM" = linux-amd64 ]; then
  ...
  cmake -S "$SRC/runtimes" -B build-crt -G Ninja \
    ...
    -DCMAKE_C_COMPILER_TARGET=x86_64-unknown-linux-gnu -DCMAKE_CXX_COMPILER_TARGET=x86_64-unknown-linux-gnu -DCMAKE_ASM_COMPILER_TARGET=x86_64-unknown-linux-gnu \
